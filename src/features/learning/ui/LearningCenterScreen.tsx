    ...
    >
      <View className="flex-1">
        ...
        >
          ...
          <View>
            <View
              className="mx-0 md:mx-4 lg:mx-8 mb-0 md:mb-4 lg:mb-6 bg-white/60 md:backdrop-blur-2xl md:border md:border-white/60 md:rounded-[32px] lg:rounded-[40px] overflow-hidden"
              style={{
                shadowColor: "#000",
