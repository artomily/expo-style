...
export default function WelcomeScreen(): React.ReactElement {
  ...
  return (
    ...
    >
      ...
      <View
        className="flex-1 mx-0 md:mx-6 my-0 md:my-6 rounded-none md:rounded-[40px] overflow-hidden"
        style={{
              ...
              {FEATURE_CARDS.map((card) => {
                ...
                return (
                  <Pressable
                    ...
                    style={{
                      width: isLargeScreen ? '31%' : '100%', // Full width on mobile, 3 columns on desktop
                      maxWidth: isLargeScreen ? undefined : 500,
                      minWidth: isLargeScreen ? 100 : undefined,
                      backgroundColor: theme === "dark"
